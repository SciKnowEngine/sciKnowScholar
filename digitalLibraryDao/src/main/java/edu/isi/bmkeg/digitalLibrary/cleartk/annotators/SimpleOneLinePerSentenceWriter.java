...
public class SimpleOneLinePerSentenceWriter extends JCasAnnotator_ImplBase {

	public final static String PARAM_DIR_PATH = ConfigurationParameterFactory
			.createConfigurationParameterName( SimpleOneLinePerSentenceWriter.class, "dirPath" );
	...
	public void process(JCas jCas) throws AnalysisEngineProcessException {
		...
		File outFile = new File(baseData.getPath() + "/" + c.getName() + "/" + ac.getPmid() + ".txt" ); 
